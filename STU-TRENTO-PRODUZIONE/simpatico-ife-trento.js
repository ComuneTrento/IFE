...
//  });
  ...
  buttons = [{
                  ...
                  imageSrcEnabled: "https://cdn.jsdelivr.net/gh/ComuneTrento/SPRINT-IFE/STU-TRENTO-PRODUZIONE/img/ic_on.png",
                  imageSrcDisabled: "https://cdn.jsdelivr.net/gh/ComuneTrento/SPRINT-IFE/STU-TRENTO-PRODUZIONE/img/login.png",
                  alt: "Entra",
                ...
                { // WAE. Switch to the modality, where the form adaptation starts
                    id: 'workflow',
                    imageSrcEnabled: "https://cdn.jsdelivr.net/gh/ComuneTrento/SPRINT-IFE/STU-TRENTO-PRODUZIONE/img/forms.png",
                    imageSrcDisabled: "https://cdn.jsdelivr.net/gh/ComuneTrento/SPRINT-IFE/STU-TRENTO-PRODUZIONE/img/forms.png",
                ...
                { // CITIZENPEDIA
                  ...
                  // Ad-hoc images to define the enabled/disabled images
                  imageSrcEnabled: "https://cdn.jsdelivr.net/gh/ComuneTrento/SPRINT-IFE/STU-TRENTO-PRODUZIONE/img/citizenpedia.png",
                  imageSrcDisabled: "https://cdn.jsdelivr.net/gh/ComuneTrento/SPRINT-IFE/STU-TRENTO-PRODUZIONE/img/citizenpedia.png",
                ...
                { // TAE
                    ...
                    // Ad-hoc images to define the enabled/disabled images
                    imageSrcEnabled: "https://cdn.jsdelivr.net/gh/ComuneTrento/SPRINT-IFE/STU-TRENTO-PRODUZIONE/img/enrich.png",
                    imageSrcDisabled: "https://cdn.jsdelivr.net/gh/ComuneTrento/SPRINT-IFE/STU-TRENTO-PRODUZIONE/img/enrich.png",
                    ...
                    { // CPD: procedure model
                        id: 'process',
                        imageSrcEnabled: "https://cdn.jsdelivr.net/gh/ComuneTrento/SPRINT-IFE/STU-TRENTO-PRODUZIONE/img/diagram.png",
                        imageSrcDisabled: "https://cdn.jsdelivr.net/gh/ComuneTrento/SPRINT-IFE/STU-TRENTO-PRODUZIONE/img/diagram.png",
...
//  if (!isProd()) {
    buttons.splice(buttons.length - 1, 0, { // CDV
        id: "simp-bar-sw-cdv",
          // Ad-hoc images to define the enabled/disabled images
          imageSrcEnabled: "https://cdn.jsdelivr.net/gh/ComuneTrento/SPRINT-IFE/STU-TRENTO-PRODUZIONE/img/cdv.png",
          imageSrcDisabled: "https://cdn.jsdelivr.net/gh/ComuneTrento/SPRINT-IFE/STU-TRENTO-PRODUZIONE/img/cdv.png",
...
document.addEventListener('simpaticoEvent', function () {
  ...
  document.getElementsByTagName( "head" )[0].appendChild( link );
  link = document.createElement( "link" );
  link.href = "https://cdn.jsdelivr.net/gh/ComuneTrento/SPRINT-IFE/STU-TRENTO-PRODUZIONE/css/trento.css";
  link.type = "text/css";
  link.rel = "stylesheet";
  document.getElementsByTagName( "head" )[0].appendChild( link );
  link = document.createElement( "link" );
...
function tutorialContent(step) {
  ...
  case 1: return '<table><tr><td><img src="https://cdn.jsdelivr.net/gh/ComuneTrento/SPRINT-IFE/STU-TRENTO-PRODUZIONE/img/forms.png"></td><td width="100%">La funzionalitÃ  COMPILAZIONE GUIDATA ti accompagna passo-passo nella compilazione del modulo online.</td></tr></table>';
  case 2: return '<table><tr><td><img src="https://cdn.jsdelivr.net/gh/ComuneTrento/SPRINT-IFE/STU-TRENTO-PRODUZIONE/img/citizenpedia.png"></td><td width="100%">La funzionalitÃ  DOMANDE E RISPOSTE ti permette di leggere e/o inserire domande legate a specifiche sezioni del servizio.</td></tr></table>';
  case 3: return '<table><tr><td><img src="https://cdn.jsdelivr.net/gh/ComuneTrento/SPRINT-IFE/STU-TRENTO-PRODUZIONE/img/enrich.png"></td><td width="100%">La funzionalitÃ  SEMPLIFICAZIONE TESTO mette a disposizione strumenti per meglio comprendere le frasi nel modulo. Per attivarla devi selezionare il testo da semplificare e cliccare sull\'icona.</td></tr></table>';
  case 4: return '<table><tr><td><img src="https://cdn.jsdelivr.net/gh/ComuneTrento/SPRINT-IFE/STU-TRENTO-PRODUZIONE/img/cdv.png"></td><td width="100%">La funzionalitÃ  DATI PERSONALI ti consente di salvare e recuperare in altri moduli le informazioni che hai inserito (es. nucleo familiare).</td></tr></table>';
  case 5: return '<table><tr><td><img src="https://cdn.jsdelivr.net/gh/ComuneTrento/SPRINT-IFE/STU-TRENTO-PRODUZIONE/img/diagram.png"></td><td width="100%">La funzionalitÃ  PROCEDURA ti permette di avere uno sguardo di insieme dei passi previsti per lâ€™attivazione e lâ€™utilizzo del servizio.</td></tr></table>';
//  case 6: return '<table><tr><td><img src="https://cdn.jsdelivr.net/gh/ComuneTrento/SPRINT-IFE/STU-TRENTO-PRODUZIONE/img/feedback.png"></td><td width="100%">La funzione FEEDBACK ti consente di esprimere in ogni momento una valutazione rispetto alle funzionalitÃ  di SIMPATICO.</td></tr></table>';
  }
}
